...
void Complete_timer_checker(Queue q[]){
 bool a = not_Complete(q);
 for(int i=0;i<3;i++){
...
int main(){
 ...
 //here we have aqueue which is not executed completely
 //start processing the incomplete process
 if(l==0){
